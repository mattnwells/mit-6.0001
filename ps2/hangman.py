    ...
    while not is_word_guessed(secret_word, letters_guessed) and guesses_remaining > 0:
        ...
        if not letter or letter not in string.ascii_lowercase:
            if warnings_remaining != 0:
                ...
                print("That is not a valid letter. You have", warnings_remaining, "warnings left.")
            else:
                print("That is not a valid letter. You have no warnings left, so you lose one guess.")
                guesses_remaining -= 1
            ...
            if warnings_remaining != 0:
                ...
                print("You've already guessed that letter. You have no warnings left, so you lose one guess.")
                guesses_remaining -= 1
        ...
        if is_word_guessed(secret_word, letters_guessed):
            ...
            print("Your total score for this game is", good_guess * guesses_remaining, ".")
...
def hangman_with_hints(secret_word):
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while not is_word_guessed(secret_word, letters_guessed) and guesses_remaining > 0:
       ...
       if letter == "*":
           print("Possible matches are:", show_possible_matches(get_guessed_word(secret_wrord, letters_guessed)))
